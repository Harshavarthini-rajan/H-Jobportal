...
const applyForJob = (originalJob) => {
    // 1. Current User (Ajeeth) id-ah check panni Alluser array-ah update pandrom
    // Ippo dhaan PostedJobs count-um ViewApplicants table-um sync aagum
    ...
    // 3. User side tracking-ku 'appliedJobs' state-a update pandrom
    const newAppliedJob = {
        ...originalJob,
