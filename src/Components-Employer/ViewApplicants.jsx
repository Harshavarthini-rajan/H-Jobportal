...
export const ViewApplicants = ({ job }) => {
  ...
  <div className="tab-pane">
    ...
    <section className="info-section document-section">
    ...
    <section className="info-section">
      ...
      <div className="cover-letter-box">
        <p>
          {/* Ajeeth or any other user-ku context-la responsibilities key-la dhaan data iruku, so adhayae cover letter ah kaatuvom */}
